...
export type InventoryItemListingFragment = { __typename?: 'InventoryItem', name: string, value: number, quantity: number, traits: Array<string>, description: string, bulk: number, level: number } & { ' $fragmentName'?: 'InventoryItemListingFragment' };
