...
export type InventoryItemListingFragment = { __typename?: 'InventoryItem', name: string, value: number, displayValue: string, quantity: number, traits: Array<string>, description: string, bulk: number, level: number } & { ' $fragmentName'?: 'InventoryItemListingFragment' };
